...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "appDescription": MessageLookupByLibrary.simpleMessage(
            "FitTrack, gizliliğinize saygı duyan ücretsiz ve açık kaynaklı bir kalori ve besin takipçisidir."),
        "appLicenseLabel":
            MessageLookupByLibrary.simpleMessage("GPL-3.0 lisansı"),
        "appTitle": MessageLookupByLibrary.simpleMessage("FitTrack"),
        "appVersionName": m0,
        "baseQuantityLabel":
        ...
        "disclaimerText": MessageLookupByLibrary.simpleMessage(
            "FitTrack bir tıbbi uygulama değildir. Sağlanan tüm veriler doğrulanmamıştır ve dikkatle kullanılmalıdır. Lütfen sağlıklı bir yaşam tarzı sürdürün ve herhangi bir sorununuz varsa bir profesyonele danışın. Hastalık, hamilelik veya emzirme döneminde kullanımı önerilmez.\n\n\nUygulama hala geliştirme aşamasındadır. Hatalar, aksaklıklar ve çökmeler meydana gelebilir."),
        "editItemDialogTitle":
