...
List<Food> foodList = [
  ...
  carbsvalue: 1.1,
  fatsvalue: 9.5,
  description: 'Complete protein source containing all essential amino acids. Rich in choline for brain health and lutein for eye protection. Versatile cooking ingredient.',
  calorie: '143 Kcal',
  protein: '12.6g',
  carbs: '1.1g',
  tfat: '9.5g',
  ...
  carbsvalue: 12.0,
  fatsvalue: 1.4,
  description: 'Whole grain packed with soluble fiber (beta-glucan) that helps lower cholesterol. Provides sustained energy and supports gut health.',
  calorie: '68 Kcal',
  protein: '2.4g',
  carbs: '12.0g',
  tfat: '1.4g',
  ...
  carbsvalue: 6.6,
  fatsvalue: 0.4,
  description: 'Cruciferous vegetable loaded with vitamins C/K, folate, and sulforaphane. Has potent anti-cancer properties and supports detoxification.',
  calorie: '34 Kcal',
  protein: '2.8g',
  carbs: '6.6g',
  tfat: '0.4g',
  ...
  carbsvalue: 20.0,
  fatsvalue: 50.0,
  description: 'Plant-based protein source rich in healthy fats. Contains resveratrol and CoQ10. Choose natural varieties without added sugars or hydrogenated oils.',
  calorie: '588 Kcal',
  protein: '25.0g',
  carbs: '20.0g',
  tfat: '50.0g',
  ...
  carbsvalue: 14.5,
  fatsvalue: 0.3,
  description: 'Antioxidant powerhouse with anthocyanins that support brain health and reduce oxidative stress. Low glycemic index despite natural sweetness.',
  calorie: '57 Kcal',
  protein: '0.7g',
  carbs: '14.5g',
  tfat: '0.3g',
  ...
  carbsvalue: 23.0,
  fatsvalue: 0.9,
  description: 'Whole grain containing the bran and germ. Provides manganese, selenium, and fiber. Slower digesting than white rice for better blood sugar control.',
  calorie: '111 Kcal',
  protein: '2.6g',
  carbs: '23.0g',
  tfat: '0.9g',
  ...
  carbsvalue: 3.6,
  fatsvalue: 0.4,
  description: 'Leafy green loaded with iron, vitamin K, and nitrates. Supports blood health, bone strength, and may improve athletic performance.',
  calorie: '23 Kcal',
  protein: '2.9g',
  carbs: '3.6g',
  tfat: '0.4g',
  ...
  carbsvalue: 13.7,
  fatsvalue: 65.2,
  description: 'Tree nuts with the highest omega-3 ALA content. Supports brain health and reduces inflammation. Contains melatonin for better sleep regulation.',
  calorie: '654 Kcal',
  protein: '15.2g',
  carbs: '13.7g',
  tfat: '65.2g',
  ...
  carbsvalue: 42.1,
  fatsvalue: 30.7,
  description: 'Tiny seeds packed with omega-3s, fiber, and calcium. Form gel-like consistency when soaked. Supports hydration and digestive health.',
  calorie: '486 Kcal',
  protein: '16.5g',
  carbs: '42.1g',
  tfat: '30.7g',
  ...
  carbsvalue: 0.0,
  fatsvalue: 0.0,
  description: 'Contains catechins like EGCG with powerful antioxidant effects. May boost metabolism and support brain function. Brew fresh for maximum benefits.',
  calorie: '0 Kcal',
  protein: '0.0g',
  carbs: '0.0g',
  tfat: '0.0g',
  ...
  carbsvalue: 20.0,
  fatsvalue: 0.4,
  description: 'Plant-based protein and iron source. High in fiber and folate. Supports heart health and helps regulate blood sugar levels.',
  calorie: '116 Kcal',
  protein: '9.0g',
  carbs: '20.0g',
  tfat: '0.4g',
  ...
  carbsvalue: 13.0,
  fatsvalue: 0.4,
  description: 'Tropical fruit with prebiotic fiber and betalain antioxidants. Supports gut microbiome diversity. Mildly sweet with striking appearance.',
  calorie: '60 Kcal',
  protein: '1.2g',
  carbs: '13.0g',
  tfat: '0.4g',
